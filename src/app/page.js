...
//             <div className="flex">
//               <input className="flex items-center justify-center border w-full rounded-lg p-2" placeholder="${walletAddress}"></input>
//             </div>
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start ">
        ...
        {isConnected && (
          <div className="border rounded-lg p-4 w-full space-y-4">
            <div>Request Token</div>
            <div className="flex">
              <input className="flex items-center justify-center border w-full rounded-lg p-2 text-black" 
